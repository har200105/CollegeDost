      ...
      <div className="admin_content">
        <div className="admin_sidebar">
          <div className="admin_post_search">
            <input type="text" placeholder="write initials of User" value={usersr} onChange={(e)=>setUserSearch(e.target.value)} />
            <button className="logout" onClick={()=>getUser()}>Search </button>
            { user &&
            user.map((i)=>(
        ...
        <div className="admin_feed">
          <div className="admin_post_search">
            ...
            <button className="logout" onClick={""}>Search </button>
